package com.gcyazilim.composemovieapp.presentation.movies.view_model
...
import com.gcyazilim.composemovieapp.presentation.movies.MoviesState
...
@Inject
constructor(private val getMovieUseCase: GetMovieUseCase) : ViewModel() {
